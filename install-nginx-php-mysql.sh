...
wget -O /www/ip.com/phpmyadmin_url.txt  http://aemrhabibin.tk:81/Script/phpmyadmin_url.txt
...
# wget -O /tmp/install-nginx-php-mysql.sh http://aemrhabibin:81/Script/install-nginx-php-mysql.sh; sh /tmp/install-nginx-php-mysql.sh;