...
;;
*)
  echo " gunakan perintah ./user-limit-op.sh 1 untuk limit 1 login saja"
  echo " atau ./user-limit-op.sh 2  untuk melimit max 2 login"   
rm -f /tmp/pid
rm -f /tmp/pid2
rm -f /tmp/pids
rm -f /tmp/sks
